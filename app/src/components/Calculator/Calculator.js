...
const calcImg = "https://github.com/tiffanyls/react-intro-class/blob/master/calculator.png?raw=true"
    ...
    render () {
        return (
            <div id="calculator-container">
              ...
              <img className="remove-highlight" src={calcImg} alt="calculator" />
